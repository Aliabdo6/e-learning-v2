...
//   return (
//     <aside className="w-full md:w-64 bg-gray-100 dark:bg-gray-800 p-4 rounded-lg sticky top-0 h-[80vh] overflow-hidden">
//       <button
...
//         className={`${
//           isOpen ? "block" : "hidden"
//         } md:block overflow-y-auto h-full overflow-x-hidden`}
//       >
